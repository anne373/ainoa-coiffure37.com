          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                className="flex items-center gap-2 bg-[#1877F2] text-white px-5 py-3 rounded-xl font-inter font-bold text-[14px] tracking-widest uppercase hover:brightness-110 transition-all"
              >
              ...
              <a
                ...
                target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2 bg-[#E1306C] text-white px-5 py-3 rounded-xl font-inter font-bold text-[14px] tracking-widest uppercase hover:brightness-110 transition-all"
              >
                <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
