export default function ConceptSection() {
  return (
    <section id="concept" className="py-12 md:py-[80px] bg-[#FFF7F2]">
      <div className="max-w-[1280px] mx-auto px-8 grid grid-cols-12 gap-6 items-start">
        ...
        <div className="col-span-12 md:col-span-5">
          ...
          <h2 className="text-[22px] sm:text-[28px] md:text-[36px] lg:text-h2 leading-tight font-space-grotesk font-semibold uppercase text-zinc-900 mb-4 md:mb-10">
            Notre Savoir-Faire
          </h2>
        </div>
